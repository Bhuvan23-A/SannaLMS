    ...
    <div className="app-container" style={{ paddingTop: '2rem' }}>
      <header className="header-banner">
        <button 
          onClick={() => navigate('/')}
          style={{
            position: 'absolute', left: 0, top: '10px', display: 'flex', alignItems: 'center', gap: '0.25rem',
            background: 'transparent', border: 'none', color: 'var(--text-secondary)', cursor: 'pointer', fontWeight: 600
          }}>
          <ArrowLeft size={16} /> Back to Gateway Home
        </button>
        <span className="badge" style={{ marginTop: '1.5rem' }}>PART 3 DEV CONSOLE</span>
              ...
              <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                  <div>
                    ...
                    <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Assign each student's file to peer reviewers anonymously.</p>
                  </div>
                  <button
